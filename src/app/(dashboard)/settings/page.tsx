    ...
    <div className="max-w-lg">
      ...
      <Card className="p-5">
        ...
        <p className="mt-1 text-xs text-neutral-500 dark:text-neutral-400">
          Rol: {role === "admin" ? "Admin" : "Miembro"} · La cartera de leads es compartida por todo el equipo.
        </p>
        {role === "admin" && (
          <Link href="/users" className="mt-3 inline-block text-sm font-medium text-neutral-900 hover:underline dark:text-neutral-100">
            Gestionar usuarios →
          </Link>
        )}
